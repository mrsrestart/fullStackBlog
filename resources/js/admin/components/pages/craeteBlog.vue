                ...
                <div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
                    ...
                    <div class="_overflow _table_div">
                        ...
                        <div class="inputCss">
                            ...
                            <button class="bttonStyle" :loding="this.isCreating" :disabled="this.isCreating" @click="save">{{this.isCreating ? 'Pls Wait...' : 'Create Blog'}}</button>
        ...
        async addRole() {
         ...
         save() {
                ...
                .then(async (data) => {
                    ...
                    const res = await this.callApi(this.data,'post','/app/create_blog');
                    console.log("this is rest" , res);
                    if(res.status == 200){
                        this.success("Your Blog Successfully Created")
