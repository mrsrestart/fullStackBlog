                    ...
                    <div class="_overflow _table_div">
                        <table class="_table">
                            ...
                            <tr v-for="(tag ,i) in tags" :key="i" v-if="tags.length">
                                ...
                                <td>
                                    <button class="_btn _action_btn edit_btn1" v-if="isUpdatePermitted"  @click="showEditModal(tag , i)"
                                            type="button">Edit
                                    </button>
                                    <button class="_btn _action_btn make_btn1" v-if="isDeletePermitted" @click="showDeleteModal(tag , i)"
